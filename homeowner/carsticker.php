...
<div class="content-wrapper">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Car Sticker</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <label for="carRegistration">Upload Car Registration (CR):</label>
            <input type="file" id="carRegistration" name="carRegistration" accept=".pdf,.doc,.docx,.jpg,.jpeg,.png" required>
            <br><br>
        ...
        <script>
            ...
            document.getElementById('carSticker').addEventListener('change', function() {
                var rfid = this.value;
                fetchPrice(rfid);
            });
            ...
            function fetchPrice(rfid) {
                fetch('get_price.php?carSticker=' + rfid)
