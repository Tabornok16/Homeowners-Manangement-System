        ...
        <div class="card">
            <div class="card-body">
                ...
                if ($result && isset($_GET['amount']) && isset($_GET['value'])) {
                    ...
                    $paymentMessage = "<br> <br> Payment of PHP $amount for $value under $subcategory - $type - $subtype by $unitStakeholder. <br><br> Deposit in neither of these Banks. <br> <br> BPI Account
<br> Bank Account Name: Jubilation Home Village East Homeowner's Association Inc. <br> Account Number: 002641-0027-02 <br> BPI Biñan City <br> <br>  
 BDO Account
<br> Bank Account Name: Jubilation Home Village East Homeowner's Association Inc. <br> Account Number: 0166-12112-12 <br> BDO Biñan City <br> <br>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <input type="text" class="form-control" id="tx_no" name="tx_no" value="<?php echo filter_var($_GET['value'], FILTER_SANITIZE_STRING); ?>" hidden> </input>
                                    <input type="text" class="form-control" id="paymentfor" name="paymentfor" value="<?php echo $subcategory ?>" hidden> </input>
                                    <!-- <input type="text" class="form-control" id="ref_no" name="ref_no" value="<?php echo $subcategory ?>" hidden> </input> -->
...
<script>
    $(document).ready(function() {
        $('form').submit(function(event) {
            ...
            // Log the FormData object before passing it
            var formData = new FormData(this);
            console.log('Form data before AJAX submission:', formData);
